...
export default function QuestionDetails() {
  ...
  return (
    <>
      ...
      <div className="mx-auto mt-10 mb-10 w-9/12 rounded-lg p-4 shadow-[0_4px_4px_0px_rgba(0,0,0,0.30)]">
              ...
              {questionData?.module ? (
                <>
                  <span className="mx-6 rounded-3xl bg-[#B197FC] px-3 py-1 text-white">
                    {questionData ? questionData.module : ''}
                  </span>
                </>
              ) : (
                ''
        ...
        {questionData?.github_repo ? (
          <>
            <div className="mt-6 mb-4">
              <h1 className="text-lg">
                <Link
                  target="_blank"
                  to={questionData ? questionData.github_repo : ''}
                  className="flex"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
      ...
      {/* TAGS */}
      <div className="mx-auto mt-10 mb-10 w-9/12">
